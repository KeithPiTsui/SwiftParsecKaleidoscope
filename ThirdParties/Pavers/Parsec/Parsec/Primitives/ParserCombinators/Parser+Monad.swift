...
/// m b -> m a -> m b
public func -<< <S, U, A, B> (_ b: @escaping LazyParser<S, U, A>, _ a: @escaping LazyParser<S, U, B>)
  -> LazyParser<S, U, A> {
    return a >>- b
}


public func -<< <S, U, A, B> (_ b: Parser<S, U, A>, _ a: @escaping LazyParser<S, U, B>)
  -> LazyParser<S, U, A> {
    return a >>- b
}

public func -<< <S, U, A, B> (_ b: @escaping LazyParser<S, U, A>, _ a: Parser<S, U, B>)
  -> LazyParser<S, U, A> {
    return a >>- b
}

public func -<< <S, U, A, B> (_ b: Parser<S, U, A>, _ a: Parser<S, U, B>) -> Parser<S, U, A> {
  return a >>- b
}
